...
namespace Arcade.Gameplay
{
    public class ArcSkinManager : MonoBehaviour
    {
        ...
        public void SetComboTextSkin(int index)
        {
            index = Mathf.Clamp(index, 0, ComboTextColors.Length - 1);
            ComboText.color = ComboTextColors[index];
            ComboShadow.effectColor = ComboTextColors[index];
        }
    }
}
