    ...
    public class MarkingMenuItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public string Text
        {
            ...
            set
            {
                if (HasSubMenu) value += "·";
                ItemText.text = value;
                TextGenerator generator = ItemText.cachedTextGenerator;
                ItemRectTransform.sizeDelta = new Vector2(45 + ItemText.CalculateWidth(value), ItemRectTransform.sizeDelta.y);
            }
        }
